...
function generate_new_transaction_number() {
	...
	$subject = 'Weego Phils - Order Confirmation';
    ...
    $transaction ->setAmount($amount)
                ...
                ->setDescription('Payment for WeeGo Purchase')
                ->setInvoiceNumber(uniqid("WeeGo"));

    $redirectUrls = new RedirectUrls();
    $redirectUrls
        ->setReturnUrl('http://localhost/batch19/qstore/app/controllers/pay.php?success=true')
        ->setCancelUrl('http://localhost/batch19/qstore/app/controllers/pay.php?success=false');
